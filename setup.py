...
setup(
    name="relative_grid_attn",
    version="1.0",
    author="Andy Barcia Rodríguez",
    url="https://github.com/AndyBarcia/relative_grid_attn",
    description="PyTorch Wrapper for CUDA Functions of Relative Grid Attention",
